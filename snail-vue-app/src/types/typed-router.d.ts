...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/auth': RouteRecordInfo<'/auth', '/auth', Record<never, never>, Record<never, never>, '/auth/' | '/auth/forgot-password' | '/auth/login' | '/auth/oidc-login' | '/auth/otp' | '/auth/sign-in' | '/auth/sign-up'>,
    ...
    '/auth/oidc-login': RouteRecordInfo<'/auth/oidc-login', '/auth/oidc-login', Record<never, never>, Record<never, never>>,
